...
from nnunetv2.networks.ma_sam.model.segmentation_sub_network.selective_scan_interface_ca import mamba_inner_fn
...
class Mamba(nn.Module):
    def __init__(
        ...
        self.in_proj_q = nn.Linear(self.d_model, self.d_inner, bias=bias, **factory_kwargs)
