...
from nnunetv2.training.dataloading.base_data_loader_cross import nnUNetDataLoaderBase
...
class nnUNetDataLoader2D(nnUNetDataLoaderBase):
    def generate_train_batch(self):
        ...
        for j, current_key in enumerate(selected_keys):
            ...
            data, seg, seg2, properties = self._data.load_case(current_key)
            ...
            with torch.no_grad():
                with threadpool_limits(limits=1, user_api=None):
                    ...
                    for b in range(self.batch_size):
                        ...
                        temp_merge = torch.cat((seg_all[b], seg_all2[b]), dim=0)
                    ...
                    del segs, images, segs2

            return {'data': data_all, 'target': seg_all, 'target2': seg_all2, 'keys': selected_keys}
