...
from nnunetv2.training.dataloading.utils_prostate_triple import get_case_identifiers


class nnUNetDataset_Prostate_Triple(object):
...
if __name__ == '__main__':
    ...
    train_set = nnUNetDataset_Prostate_Triple(folder)
    ...
    # for i, current_key in enumerate(train_loader):
        # print(id)
        # print(slice)
        # print(data.shape)
        # print(seg.shape)
