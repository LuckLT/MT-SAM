...
from nnunetv2.networks.Maba_UNet.vision_mamba import MambaUnet as VIM_seg
import nnunetv2.networks.SwinUnet_configs as get_config
from nnunetv2.networks.UNet_multi_level import UNet_multi_level
import argparse
class nnUNetTrainer_multilevel(nnUNetTrainer):
    ...
    def build_network(self):
        net = UNet_multi_level(input_channels=3,
                                n_stages=5,
