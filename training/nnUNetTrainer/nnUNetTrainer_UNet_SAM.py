...
from nnunetv2.networks.ma_sam.model.segmentation_sub_network.UNet_SAM import UNet_SAM, HMTUNet
import argparse
import torch.nn.functional as F
import torch._dynamo
torch._dynamo.config.suppress_errors = True
class nnUNetTrainer_UNet_SAM(nnUNetTrainer):
    ...
    def build_network(self):
        net = UNet_SAM(num_classes=2, num_atlas=1, encoder_embed_dim=768, encoder_depth=12, encoder_num_heads=12,
