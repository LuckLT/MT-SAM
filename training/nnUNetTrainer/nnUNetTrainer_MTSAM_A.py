...
from nnunetv2.networks.ma_sam.model.segmentation_sub_network.Mamba_SAM_Pyramid_A import Mamba_SAM_Pyramid_A, HMTUNet
import argparse
import torch.nn.functional as F
import torch._dynamo
torch._dynamo.config.suppress_errors = True
class nnUNetTrainer_MTSAM_A(nnUNetTrainer):
    ...
    def build_network(self):
        net = Mamba_SAM_Pyramid_A(num_classes=2, num_atlas=1, encoder_embed_dim=768, encoder_depth=12, encoder_num_heads=12,
