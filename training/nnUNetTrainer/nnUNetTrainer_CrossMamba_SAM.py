...
from nnunetv2.networks.ma_sam.model.segmentation_sub_network.CrossMamba_SAM import CrossMamba_SAM, HMTUNet
import argparse
import os
os.environ['CUDA_LAUNCH_BLOCKING'] = "1"
os.environ['TORCH_USE_CUDA_DSA'] = "1"
class nnUNetTrainer_CrossMambaSAM(nnUNetTrainer):
    ...
    def build_network(self):
        net = CrossMamba_SAM(num_classes=2, num_atlas=1, encoder_embed_dim=768, encoder_depth=12, encoder_num_heads=12,
