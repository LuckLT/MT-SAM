...
from nnunetv2.networks.ma_sam_ori.model.segmentation_sub_network.MASAM import MASAM
import argparse
class nnUNetTrainer_MASAM(nnUNetTrainer):
    ...
    def build_network(self):
        net = MASAM(num_classes=2, num_atlas=1, encoder_embed_dim=768, encoder_depth=12, encoder_num_heads=12,
