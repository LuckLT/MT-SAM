...
from nnunetv2.networks.ma_sam.model.segmentation_sub_network.Mamba_SAM_multiscale import Mamba_SAM_multiscale, HMTUNet
import argparse
import os
os.environ['CUDA_LAUNCH_BLOCKING'] = "1"
os.environ['TORCH_USE_CUDA_DSA'] = "1"
class nnUNetTrainer_MambaSAM_multiscale(nnUNetTrainer):
    ...
    def build_network(self):
        net = Mamba_SAM_multiscale(num_classes=2, num_atlas=1, encoder_embed_dim=768, encoder_depth=12, encoder_num_heads=12,
