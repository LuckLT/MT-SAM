...
from nnunetv2.networks.UNet_Dinov2 import UNet_Dinov2
import nnunetv2.networks.vit_seg_configs as configs

class nnUNetTrainer_Dinov2(nnUNetTrainer):
    ...
    def build_network(self):
        ...
        net = UNet_Dinov2(CONFIGS['ViT-L_16'], img_size=224, num_classes=2, zero_head=False, vis=False)
