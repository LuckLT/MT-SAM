...
from nnunetv2.networks.TransUNet import VisionTransformer
import nnunetv2.networks.vit_seg_configs as configs
from nnunetv2.networks.Seg_UKAN.archs import UKAN
class nnUNetTrainer_UKAN(nnUNetTrainer):
    ...
    def build_network(self):
        net = UKAN(num_classes=2, input_channels=3, deep_supervision=False, img_size=224, patch_size=16, in_chans=3,
